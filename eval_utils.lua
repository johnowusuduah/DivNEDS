--Lua evaluation script written by Johnson, J., Karpathy, A., & Fei-Fei, L. (2016). Densecap: Fully convolutional localization networks for dense captioning. In Proceedings of the IEEE 
--conference on computer vision and pattern recognition (pp. 4565-4574).
