...
class ViT(Backbone):
    ...
    def __init__(
        ...
        self.pos_embed_level3 = nn.Parameter(torch.zeros(1, num_patches, embed_dim))

        trunc_normal_(self.pos_embed_level1, std=0.02)
        trunc_normal_(self.pos_embed_level2, std=0.02)
        trunc_normal_(self.pos_embed_level3, std=0.02)
